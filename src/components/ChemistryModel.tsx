...
import { Maximize2, Minimize2, RefreshCw, Beaker, Download, ChevronRight, Play, Pause } from 'lucide-react';
...
Use ONLY these exact fields and types. No additional fields.`;
      ...
      try {
        ...
        setSimulationConfig(validatedConfig);
...
Use ONLY these exact fields and types. No additional fields.`;
      ...
      try {
        ...
        setAnimationConfig(validatedConfig);
